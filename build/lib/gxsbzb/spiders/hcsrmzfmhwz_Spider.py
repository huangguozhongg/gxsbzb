...
# 通知公告，政策解读，新闻发布
class hcsrmzfmhwz_tzx_Spider(Spider):

    # 爬虫名
    name = 'hcsrmzfmhwz_tzx'
    # 网站标题
    __WebTitle = '广西河池市人民政府门户网站'
    # 网站地址
    __WebUrl = 'http://www.hechi.gov.cn/'
    # 网站节点
    __WebNodes = [
                  '通知公告',
                  '信息公开政策解读',
    ...
    # 网站节点地址
    __WebNodeUrls = [  'http://www.hechi.gov.cn/tzgg/index-%s.shtml',
                       'http://www.hechi.gov.cn/xxgk/zcjd/index-%s.shtml',
                       'http://www.hechi.gov.cn/xxgk/xwfb/index-%s.shtml'
