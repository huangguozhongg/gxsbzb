...
# 工作动态，通知公告，政策法规，招标信息
class qzsggzyjyzx_gtzz_Spider(Spider):

    # 爬虫名
    name = 'qzsggzyjyzx_gtzz'
    # 网站标题
    __WebTitle = '广西钦州市公共资源交易中心'
    # 网站地址
    __WebUrl = 'http://ggzyjy.qinzhou.gov.cn/gxqzzbw/default.aspx'
    # 网站节点
    __WebNodes = [
                  '招投标交易动态工作动态',
                  '通知公告',
    ...
    # 网站节点地址
    __WebNodeUrls = [
                       'http://ggzyjy.qinzhou.gov.cn/gxqzzbw/ztbdt/009001/MoreInfo.aspx?CategoryNum=009001',
                       'http://ggzyjy.qinzhou.gov.cn/gxqzzbw/tzgg/MoreInfo.aspx?CategoryNum=008',

                       'http://ggzyjy.qinzhou.gov.cn/gxqzzbw/zcfg/003006/003006001/MoreInfo.aspx?CategoryNum=003006001',
                       'http://ggzyjy.qinzhou.gov.cn/gxqzzbw/zcfg/003006/003006002/MoreInfo.aspx?CategoryNum=003006002',
                       'http://ggzyjy.qinzhou.gov.cn/gxqzzbw/zcfg/003006/003006003/MoreInfo.aspx?CategoryNum=003006003',
                       'http://ggzyjy.qinzhou.gov.cn/gxqzzbw/zcfg/003006/003006004/MoreInfo.aspx?CategoryNum=003006004',
